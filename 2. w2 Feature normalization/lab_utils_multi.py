...
def gradient_descent_houses(X, y, w_in, b_in, cost_function, gradient_function, alpha, num_iters): 
    ...
    print(f"Iteation Cost          w0       w1       w2       b       djdw0    djdw1    djdw2    djdb  ")
    print(f"---------------------|--------|--------|--------|--------|--------|--------|--------|--------|")
    ...
    for i in range(num_iters):
        ...
        if i% math.ceil(num_iters/10) == 0:
            ...
            print(f"{i:9d} {cst:0.5e} {w[0]: 0.1e} {w[1]: 0.1e} {w[2]: 0.1e} {b: 0.1e} {dj_dw[0]: 0.1e} {dj_dw[1]: 0.1e} {dj_dw[2]: 0.1e} {dj_db: 0.1e}")
